...
st.write('The following data has been imported in meq/L')

os.chdir(r"C:\Users\mpedrazas\OneDrive\WalkerRanch\LaredoFm_PumpingTests\WaterQualityAnalysis")
obs=pd.read_csv("LabData.csv")
obs
